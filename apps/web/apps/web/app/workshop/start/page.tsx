      ...
      <section className="px-6 md:px-10 pt-16 md:pt-24 pb-16">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-chalk mt-8 leading-relaxed max-w-2xl font-medium">
            Free customer roster. Free service-reminder dashboard. Free
            verified profile in our directory.{' '}
            <span className="text-ash font-normal">
              Your name stays on every car you service, forever.
            </span>
          </p>
          <p className="text-base text-ash mt-5 leading-relaxed max-w-2xl">
            When that car&apos;s next mechanic asks{' '}
            <em className="text-chalk not-italic">&ldquo;who did this last?&rdquo;</em>{' '}
            — your name is the answer. Reputation compounds across customers,
            not against them.
          </p>
